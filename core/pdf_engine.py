...
\fancyhead[R]{\small \textbf{NoteKing Pro} \textcolor{gray}{$\cdot$ \href{https://github.com/bcefghj/noteking-pro}{\texttt{github.com/bcefghj/noteking-pro}}}}
\fancyfoot[L]{\small \textcolor{gray}{小红书: \textbf{@bcefghj}}}
\fancyfoot[C]{\small \thepage}
\fancyfoot[R]{\small \textcolor{gray}{\href{https://github.com/bcefghj/noteking-pro}{⭐ NoteKing Pro}}}
...
\vspace*{1.5cm}
{\large \textcolor{gray}{👑 NoteKing Pro}\par}\vspace{0.5cm}
{\huge\bfseries [TITLE]\par}\vspace{0.8cm}
{\large \textcolor{gray}{Generated by NoteKing Pro}\par}\vspace{0.2cm}
{\large \textcolor{gray}{[DATE]}\par}\vspace{2cm}
\begin{tcolorbox}[colback=gray!5,colframe=gray!40,width=0.75\textwidth,boxrule=0.5pt]
\centering
{\small \textbf{🔗 开源项目}}\quad
{\small \href{https://github.com/bcefghj/noteking-pro}{\texttt{github.com/bcefghj/noteking-pro}}}\\[4pt]
{\small \textbf{📕 小红书}}\quad
{\small \textbf{@bcefghj}}
\end{tcolorbox}
\vspace{1cm}
\end{titlepage}
